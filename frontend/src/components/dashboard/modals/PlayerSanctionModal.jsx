...
const PlayerSanctionModal = ({ player, isOpen, onClose, onSuccess }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await sanctionService.createPlayerSanction(sanctionData);
      
      if (response.success) {
        toast.success('Sanción aplicada correctamente al jugador');
        onSuccess();
      }
    } catch (error) {
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="mt-2 text-sm text-gold-700">
                            <p>Estás aplicando una sanción al jugador <strong>{player?.firstName} {player?.lastName}</strong>. Esta acción quedará registrada en el sistema.</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default PlayerSanctionModal;
